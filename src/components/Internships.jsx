  ...
  >
    <div>
      <div className="flex justify-between items-start mb-6">
        <span className="text-white/70 text-xs font-mono font-bold tracking-widest uppercase">
          {intern.duration}
        </span>
        <span className="bg-white/10 text-white text-[10px] font-black tracking-widest uppercase py-1 px-3 rounded-full border border-white/15">
          {intern.role.includes("Intern") ? "Internship" : intern.role.includes("Freelance") ? "Freelance" : "Full-Time / Contract"}
        </span>
      </div>
      <h3 className="text-white text-2xl font-black mb-1 tracking-tight">
        {intern.role}
      </h3>
      <p className="text-yellow-300 text-sm font-black tracking-wide mb-6 uppercase">
        {intern.organization}
      </p>
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20 text-center">
          ...
          <p className="text-red-100 text-base md:text-lg font-semibold max-w-lg mx-auto">
            Hands-on software engineering roles in enterprise banking, insurance mainframe, and web applications.
          </p>
        </div>
